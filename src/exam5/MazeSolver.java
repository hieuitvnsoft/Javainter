...
public class MazeSolver {
    ...
    /**
     * Makes the maze half as wide (i. e. "+---+" becomes "+-+"), so that each
     * cell in the maze is the same size horizontally as vertically. (Versus the
     * expanded version, which looks better visually.) Also, converts each line
     * of the maze from a String to a char[], because we'll want mutability when
     * drawing the solution later.
     */
     ...
     * maze "look right", and converts each line from char[] to String at the
     * same time.
     */
     ...
     * specified as a command-line argument, or on standard input if no argument
     * is specified.
     */
